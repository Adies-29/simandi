...
public class AuthService {
    ...
    public void login(String username, String plainPassword, login Login) {
        ...
        Thread authThread = new Thread(() -> {
            System.out.println("--> [THREAD-AUTH] Mulai memvalidasi login di background...");
            ...
            System.out.println("--> [THREAD-AUTH] Query MongoDB selesai dalam " + durasi + " ms!");
    ...
    public void registerUser(String fullname, String username, String plainPassword) {
         Thread regThread = new Thread(() -> {
            System.out.println("--> [THREAD-REG] Memproses pendaftaran user baru...");
            ...
            try {
                ...
                System.out.println("--> [THREAD-REG] Sukses! User baru tersimpan di MongoDB.");
                SwingUtilities.invokeLater(() -> {
                    JOptionPane.showMessageDialog(null, "Registrasi Sukses untuk user: " + username);
                });
            } catch (Exception e) {
                SwingUtilities.invokeLater(() -> {
